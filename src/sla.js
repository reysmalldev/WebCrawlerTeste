...
//<![CDATA[
var postResults = postPerPage; // postResults = 10
var numOfPages = 10;
var pageOf = ["Page", "of"];
var noPage;
var currentPage;
...
function pageCurrentBlogger() {
    var a = locationUrl;
    // operações com index na string não valores númericos da url
...
//função que gera a url da pagina
function findPostDate(a) {
    ...
    if (currentPage == 'page') {
        ...
        // last c value = similar to timestamp I THINK, postResults = 10, noPage = 1
    } else {
